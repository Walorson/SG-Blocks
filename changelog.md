...
- Now you can't connect a normal line from Conditon Block - Only True / False lines
- Operation block displays the variable to which the result is written.

***FIXES***
- Fixed the bug when you connect true/false and you key up the line become normal
- Some UI fixes